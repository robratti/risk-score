...
public class Company extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 2952803317206637173L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Company\",\"namespace\":\"io.sanlo.avro.model\",\"fields\":[{\"name\":\"id\",\"type\":\"int\"},{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"country\",\"type\":\"string\"}]}");
   ...
   */
  public Company(java.lang.Integer id, java.lang.CharSequence name, java.lang.CharSequence country) {
    this.id = id;
    this.name = name;
   ...
   */
  public static io.sanlo.avro.model.Company.Builder newBuilder() {
    return new io.sanlo.avro.model.Company.Builder();
  }
   ...
   * @return A new Company RecordBuilder
   */
  public static io.sanlo.avro.model.Company.Builder newBuilder(io.sanlo.avro.model.Company.Builder other) {
    return new io.sanlo.avro.model.Company.Builder(other);
  }
   ...
   * @return A new Company RecordBuilder
   */
  public static io.sanlo.avro.model.Company.Builder newBuilder(io.sanlo.avro.model.Company other) {
    return new io.sanlo.avro.model.Company.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Company>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.sanlo.avro.model.Company.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.sanlo.avro.model.Company other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.sanlo.avro.model.Company.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.sanlo.avro.model.Company.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.sanlo.avro.model.Company.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.sanlo.avro.model.Company.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.sanlo.avro.model.Company.Builder setCountry(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.sanlo.avro.model.Company.Builder clearCountry() {
      country = null;
