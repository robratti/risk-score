...
public class ReportUtilsTest {
    ...
    void getRiskRatingTest() {
        Assertions.assertEquals(RiskRating.UNDOUBTED, ReportUtils.getRiskRating(90));
        Assertions.assertEquals(RiskRating.LOW, ReportUtils.getRiskRating(80));
        Assertions.assertEquals(RiskRating.MODERATE, ReportUtils.getRiskRating(64));
        Assertions.assertEquals(RiskRating.UNSATISFACTORY, ReportUtils.getRiskRating(30));
        Assertions.assertEquals(RiskRating.UNACCEPTABLE, ReportUtils.getRiskRating(10));
    }
